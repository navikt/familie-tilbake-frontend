    ...
    return (
        <>
            ...
            >
                ...
                <section
                    ref={contentRef}
                    className="py-4 border-ax-border-brand-blue-subtle border rounded-2xl px-6 bg-ax-bg-default scrollbar-stable overflow-x-hidden overflow-y-auto flex-1 min-h-0"
