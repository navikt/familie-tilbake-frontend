...
export const Unntak: React.FC = () => {
    ...
    const { name, ...radioProps } = methods.register('begrunnelseForUnntak');
            ...
            <RadioGroup
                ...
                error={
                    'begrunnelseForUnntak' in methods.formState.errors
                        ? methods.formState.errors.begrunnelseForUnntak?.message
                        : undefined
                }
            >
            ...
            <Textarea
                ...
                error={
                    'beskrivelse' in methods.formState.errors
                        ? methods.formState.errors.beskrivelse?.message
                        : undefined
                }
            />
        </>
