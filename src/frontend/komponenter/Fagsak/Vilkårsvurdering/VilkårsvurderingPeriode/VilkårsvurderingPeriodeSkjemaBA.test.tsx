...
describe('Tester: VilkårsvurderingPeriodeSkjema', () => {
    ...
    test('- god tro - beløp ikke i behold', async () => {
        ...
        await waitFor(() =>
            user.type(getByLabelText('Vilkårene for tilbakekreving'), 'begrunnelse')
        );
        await waitFor(() =>
            user.click(
        ...
        await waitFor(() =>
            user.type(getByLabelText('Vurder om beløpet er i behold'), 'begrunnelse')
        );
        await waitFor(() =>
            user.click(
                getByLabelText('Nei', {
    ...
    test('- god tro - beløp i behold', async () => {
        ...
        await waitFor(() => user.type(getByLabelText('Angi beløp som skal tilbakekreves'), '2000'));
    ...
    test('- mangelfulle - simpel uaktsomhet - under 4 rettsgebyr - grunn til reduksjon', async () => {
        ...
        await waitFor(() => user.click(getByTestId('harGrunnerTilReduksjon_Ja')));
    ...
    test('- mangelfulle - simpel uaktsomhet - under 4 rettsgebyr - ingen grunn til reduksjon', async () => {
        ...
        await waitFor(() => user.click(getByTestId('harGrunnerTilReduksjon_Nei')));
