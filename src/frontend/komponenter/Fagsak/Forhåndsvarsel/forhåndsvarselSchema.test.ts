    ...
    describe('Første spørsmål: skal sende forhåndsvarsel', () => {
        ...
        test('Ja: gyldig path', () => {
            const result = forhåndsvarselSchema.safeParse({
                ...
                harBrukerUttaltSeg: {
                    harBrukerUttaltSeg: HarUttaltSeg.Nei,
        ...
        describe('harUttaltSeg', () => {
            test('IkkeValgt, gir feilmelding', () => {
                const result = forhåndsvarselSchema.safeParse({
                    ...
                    harBrukerUttaltSeg: {
                        harBrukerUttaltSeg: HarUttaltSeg.IkkeValgt,
                    },
                });
            ...
            test('Ja, gyldig validering', () => {
                const result = forhåndsvarselSchema.safeParse({
                    skalSendesForhåndsvarsel: SkalSendesForhåndsvarsel.Sendt,
                    harBrukerUttaltSeg: {
                        harBrukerUttaltSeg: HarUttaltSeg.Ja,
                        uttalelsesDetaljer: [
                            {
            ...
            test('Utsett frist, gyldig validering', () => {
                const result = forhåndsvarselSchema.safeParse({
                    skalSendesForhåndsvarsel: SkalSendesForhåndsvarsel.Sendt,
                    harBrukerUttaltSeg: {
                        harBrukerUttaltSeg: HarUttaltSeg.UtsettFrist,
