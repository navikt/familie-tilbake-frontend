...
describe('Unntak', () => {
    ...
    test('Viser beskrivelse med lenke til Forvaltningsloven', () => {
        renderUnntak();
        ...
        const lovdataLenke = screen.getByRole('link', {
            name: 'Les om Forvaltningsloven §16 på Lovdata.no',
        });
        expect(lovdataLenke).toBeInTheDocument();
        expect(lovdataLenke).toHaveAttribute('href', 'https://lovdata.no/lov/1967-02-10-10/§16a');
        expect(lovdataLenke).toHaveAttribute('target', '_blank');
        expect(lovdataLenke).toHaveAttribute('rel', 'noreferrer');
    });
