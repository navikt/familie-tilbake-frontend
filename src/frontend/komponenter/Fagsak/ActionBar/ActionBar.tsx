    ...
    return (
        <HStack
            ...
            className={classNames(
                'fixed bottom-4 bg-white px-8 py-4 rounded-2xl border-border-divider border-1 justify-between z-10 flex-nowrap lg:w-[calc((100vw*2/3)-34px)] w-[calc(100vw-32px)] min-w-96',
                {
                    '-ml-6': !dobbeltNøstet,
                    '-ml-10': dobbeltNøstet,
                }
