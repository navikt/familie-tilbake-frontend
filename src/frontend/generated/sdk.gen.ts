...
): RequestResult<TvingHenleggBehandlingResponses, unknown, ThrowOnError> =>
...
): RequestResult<KorrigerKravgrunnlagResponses, unknown, ThrowOnError> =>
...
): RequestResult<KorrigerKravgrunnlag1Responses, unknown, ThrowOnError> =>
...
): RequestResult<FlyttBehandlingTilFaktaResponses, unknown, ThrowOnError> =>
...
): RequestResult<ArkiverMottattKravgrunnlagResponses, unknown, ThrowOnError> =>
...
): RequestResult<AnnulerKravgrunnlagResponses, unknown, ThrowOnError> =>
...
): RequestResult<FjernManuellBrevmottakerResponses, unknown, ThrowOnError> =>
...
): RequestResult<OppdaterManuellBrevmottakerResponses, unknown, ThrowOnError> =>
...
): RequestResult<FjernBrevmottakerStegResponses, unknown, ThrowOnError> =>
...
): RequestResult<SettBehandlingPåVentResponses, unknown, ThrowOnError> =>
...
): RequestResult<HenleggBehandlingResponses, unknown, ThrowOnError> =>
...
): RequestResult<TaBehandlingAvVentResponses, unknown, ThrowOnError> =>
...
): RequestResult<FlyttBehandlingTilFakta1Responses, unknown, ThrowOnError> =>
...
): RequestResult<ByttEnhetResponses, unknown, ThrowOnError> =>
...
): RequestResult<AngreSendTilBeslutterResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentVergeResponses, unknown, ThrowOnError> =>
...
): RequestResult<OpprettVergeStegResponses, unknown, ThrowOnError> =>
...
): RequestResult<FjernVergeResponses, unknown, ThrowOnError> =>
...
): RequestResult<OppdaterBehandlendeEnhetPåBehandlingResponses, unknown, ThrowOnError> =>
...
): RequestResult<SammenslåResponses, unknown, ThrowOnError> =>
...
): RequestResult<AngreSammenslåingResponses, unknown, ThrowOnError> =>
...
): RequestResult<SettIverksettStegTilUtførtOgFortsettResponses, unknown, ThrowOnError> =>
...
): RequestResult<SendSisteTilstandForBehandlingerTilDvhResponses, unknown, ThrowOnError> =>
    (options.client ?? client).post<
        SendSisteTilstandForBehandlingerTilDvhResponses,
        unknown,
        ThrowOnError
...
): RequestResult<SendPåminnelseTilAlleSakerITilstandResponses, unknown, ThrowOnError> =>
    (options.client ?? client).post<
        SendPåminnelseTilAlleSakerITilstandResponses,
        unknown,
        ThrowOnError
...
): RequestResult<OppdaterFagsysteminfoResponses, unknown, ThrowOnError> =>
...
): RequestResult<MigrerAlleSakerResponses, unknown, ThrowOnError> =>
...
): RequestResult<LagOppdaterOppgaveTaskForBehandlingResponses, unknown, ThrowOnError> =>
    (options.client ?? client).post<
        LagOppdaterOppgaveTaskForBehandlingResponses,
        unknown,
        ThrowOnError
...
): RequestResult<FinnGamleÅpneBehandlingerUtenOppgaveResponses, unknown, ThrowOnError> =>
    (options.client ?? client).post<
        FinnGamleÅpneBehandlingerUtenOppgaveResponses,
        unknown,
        ThrowOnError
...
): RequestResult<FerdigstillOppgaverForBehandlingResponses, unknown, ThrowOnError> =>
    (options.client ?? client).post<
        FerdigstillOppgaverForBehandlingResponses,
        unknown,
        ThrowOnError
 ...
 */
export const dumpFagsak = <ThrowOnError extends boolean = false>(
    options: Options<DumpFagsakData, ThrowOnError>
): RequestResult<DumpFagsakResponses, unknown, ThrowOnError> =>
    (options.client ?? client).post<DumpFagsakResponses, unknown, ThrowOnError>({
        security: [{ scheme: 'bearer', type: 'http' }],
...
): RequestResult<SimulerMottakAvKravgrunnlagResponses, unknown, ThrowOnError> =>
...
): RequestResult<LagreUtkastVedtaksbrevResponses, unknown, ThrowOnError> =>
...
): RequestResult<ForhåndsvisBrevResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentForhåndsvisningVedtaksbrevResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentForhåndsvisningVarselbrevResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentForhåndsvisningHenleggelsesbrevResponses, unknown, ThrowOnError> =>
    (options.client ?? client).post<
        HentForhåndsvisningHenleggelsesbrevResponses,
        unknown,
        ThrowOnError
...
): RequestResult<BestillBrevResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentManuellBrevmottakereResponses, unknown, ThrowOnError> =>
...
): RequestResult<LeggTilBrevmottakerResponses, unknown, ThrowOnError> =>
...
): RequestResult<OpprettBrevmottakerStegResponses, unknown, ThrowOnError> =>
...
): RequestResult<UtførBehandlingsstegResponses, unknown, ThrowOnError> =>
...
): RequestResult<BeregnBeløpResponses, unknown, ThrowOnError> =>
...
): RequestResult<OpprettBehandlingResponses, unknown, ThrowOnError> =>
...
): RequestResult<OpprettRevurderingResponses, unknown, ThrowOnError> =>
...
): RequestResult<OpprettBehandlingManuellTaskResponses, unknown, ThrowOnError> =>
...
): RequestResult<KanBehandlingOpprettesManueltResponses, unknown, ThrowOnError> =>
...
): RequestResult<ErPerioderLikeResponses, unknown, ThrowOnError> =>
...
): RequestResult<ErPerioderSammenslåttResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentInfoResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentForvaltningsinfoResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentKravgrunnlagsinfoResponses, unknown, ThrowOnError> =>
...
): RequestResult<FeatureTogglesResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentVedtakForFagsystemResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentFagsakResponses, unknown, ThrowOnError> =>
...
): RequestResult<FinnesÅpenTilbakekrevingsbehandlingResponses, unknown, ThrowOnError> =>
    (options.client ?? client).get<
        FinnesÅpenTilbakekrevingsbehandlingResponses,
        unknown,
        ThrowOnError
...
): RequestResult<HentBehandlingerForFagsystemResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentVedtaksbrevtekstResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentForhåndsvarselTekstResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentUrlTilArbeidOgInntektResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentHistorikkinnslagResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentVurdertVilkårsvurderingResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentInaktivVilkårsvurderingResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentTotrinnsvurderingerResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentJournalposterResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentDokumentResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentVurdertForeldelseResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentFaktaomfeilutbetalingResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentInaktivFaktaomfeilutbetalingResponses, unknown, ThrowOnError> =>
    (options.client ?? client).get<
        HentInaktivFaktaomfeilutbetalingResponses,
        unknown,
        ThrowOnError
...
): RequestResult<HentBeregningsresultatResponses, unknown, ThrowOnError> =>
...
): RequestResult<HentBehandlingResponses, unknown, ThrowOnError> =>
