...
```tsx
<Box background="default" padding={{ xs: "space-16", md: "space-24" }} borderRadius="8">
  <VStack gap="space-24">
...
background = "neutral-soft"; // Light gray
background = "accent-soft"; // Light blue
background = "success-soft"; // Light green
background = "warning-soft"; // Light orange
background = "danger-soft"; // Light red
```
